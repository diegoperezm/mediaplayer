...
def draw_circle(x: int, y: int, radius: float, color: Color) -> None: ...
def draw_texture(texture: Texture, x: int, y: int, tint: Color) -> None: ...
...
def gui_scroll_panel(bounds: Rectangle, text: Optional[bytes], content: Rectangle, scroll: Vector2, view: Rectangle) -> Tuple[int, Rectangle]: ...
def gui_text_box(bounds: Rectangle, text: bytes, text_size: int, edit_mode: bool) -> bool: ...
def gui_text_input_box(bounds: Rectangle, title: bytes, message: bytes, buttons: bytes, text: bytes, text_size: int, secret_view_active: Optional[bool]) -> int: ...
def gui_window_box(bounds: Rectangle, title: bytes) -> bool: ...
def gui_grid(bounds: Rectangle, text: Optional[bytes], spacing: float, subdivs: int, mouse_cell: Optional[Vector2]) -> bool: ...
...
def load_wave_from_memory(fileType: bytes, fileData: bytes, dataSize: int) -> Wave: ...
...
def wave_crop(wave: Wave, initSample: int, finalSample: int) -> None: ...
def wave_format(wave: Wave, sampleRate: int, sampleSize: int, channels: int) -> None: ...
...
def load_music_stream_from_memory(fileType: bytes, data: bytes, dataSize: int) -> Music: ...
...
def gui_toggle_slider(bounds: Rectangle, text: bytes, active: int) -> int: ...
...
def gui_dropdown_box(bounds: Rectangle, text: bytes, active: int, editMode: bool) -> Tuple[int, bool]: ...
def gui_spinner(bounds: Rectangle, text: bytes, value: int, minValue: int, maxValue: int, editMode: bool) -> Tuple[int, bool]: ...
def gui_value_box(bounds: Rectangle, text: bytes, value: int, minValue: int, maxValue: int, editMode: bool) -> Tuple[int, bool]: ...
...
# --- Advance Controls ---
def gui_list_view(bounds: Rectangle, text: bytes, scrollIndex: int, active: int) -> Tuple[int, int]: ...
def gui_list_view_ex(bounds: Rectangle, text: Tuple[bytes, ...], count: int, focus: int, scrollIndex: int, active: int) -> Tuple[int, int, int]: ...
def gui_message_box(bounds: Rectangle, title: bytes, message: bytes, buttons: bytes) -> int: ...
def gui_color_picker(bounds: Rectangle, text: Optional[bytes], color: Color) -> Color: ...
def gui_color_panel(bounds: Rectangle, text: Optional[bytes], color: Color) -> Color: ...
def gui_color_bar_alpha(bounds: Rectangle, text: Optional[bytes], alpha: float) -> float: ...
def gui_color_bar_hue(bounds: Rectangle, text: Optional[bytes], value: float) -> float: ...
def gui_text_box_dropdown(bounds: Rectangle, text: bytes, active: int, editMode: bool) -> Tuple[int, bool]: ...

# --- Containers ---
def gui_group_box(bounds: Rectangle, text: bytes) -> None: ...
def gui_line(bounds: Rectangle, text: bytes) -> None: ...
def gui_tab_bar(bounds: Rectangle, text: bytes, active: int) -> int: ...
def gui_scroll_bar(bounds: Rectangle, value: int, minValue: int, maxValue: int) -> int: ...
def gui_combo_button(bounds: Rectangle, text: bytes, active: int) -> int: ...

# --- Icons ---
def gui_draw_icon(iconId: int, positionX: int, positionY: int, pixelSize: int, color: Color) -> None: ...
